...
var _user$project$Types$Thing = F8(
	function (a, b, c, d, e, f, g, h) {
		return {local: a, global: b, velocity: c, angle: d, sector: e, dimensions: f, onCollision: g, sprite: h};
	});
var _user$project$Types$Sprite = F2(
	function (a, b) {
		return {dimensions: a, src: b};
	});
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {angle: a, local: b, global: c, velocity: d, dir: e, sector: f, quadrant: g, dimensions: h, fuel: i, oxygen: j, weight: k, thrusters: l};
											};
										};
									};
								};
...
var _user$project$CollisionHandle$place = F2(
	function (_p12, _p11) {
		var _p13 = _p12;
		var _p14 = _p11;
		return {ctor: '_Tuple2', _0: _p14._0 + _p13._0, _1: _p14._1 + _p13._1};
	});
	...
	function (_p16, _p15) {
		...
		return _elm_lang$core$Native_List.fromArray(
			[
				...
				{ctor: '_Tuple2', _0: _p19 + _p17._0, _1: _p20 + _p17._1}
			]);
	});
			...
			return A2(
				...
				_elm_lang$core$Basics$fromPolar(
					A2(
						_user$project$CollisionHandle$rotatePoint,
						a,
						_elm_lang$core$Basics$toPolar(_p21))));
		};
	});
...
var _user$project$CollisionHandle$getThingsPolygon = F4(
	function (dt, _p23, _p22, t) {
		...
		return A4(
			...
			a + va,
			{ctor: '_Tuple2', _0: ((gx - _p25._0) + vx$) - _p30, _1: ((gy - _p25._1) + vy$) - _p31},
			{ctor: '_Tuple2', _0: vx$ - _p30, _1: vy$ - _p31},
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: w / 2, _1: h / 2},
					{ctor: '_Tuple2', _0: w / 2, _1: (0 - h) / 2},
...
var _user$project$CollisionHandle$dot = F2(
	function (_p33, _p32) {
		var _p34 = _p33;
		var _p35 = _p32;
		return (_p34._0 * _p35._0) + (_p34._1 * _p35._1);
	});
var _user$project$CollisionHandle$polySupport = F2(
	function (list, d) {
		var dotList = A2(
			_elm_lang$core$List$map,
			_user$project$CollisionHandle$dot(d),
			list);
		var decorated = A3(
			_elm_lang$core$List$map2,
			F2(
...
var _user$project$Consumption$consumeFuel = F2(
	function (dt, ship) {
		var _p0 = ship;
		var fuel = _p0.fuel;
		var thrusters = _p0.thrusters;
		if (_elm_lang$core$Native_Utils.cmp(fuel, 0) > 0) {
			var rate = thrusters.boost ? 3.5 : 0.5;
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$List$sum(
							_elm_lang$core$Native_List.fromArray(
								[thrusters.leftFront, thrusters.leftSide, thrusters.leftBack, thrusters.rightFront, thrusters.rightSide, thrusters.rightBack, thrusters.main * 5])))
					]));
			return _elm_lang$core$Native_Utils.update(
				ship,
...
var _user$project$Consumption$consumeAir = F2(
	function (dt, ship) {
		var _p1 = ship;
		var oxygen = _p1.oxygen;
		return (_elm_lang$core$Native_Utils.cmp(oxygen, 0) > 0) ? _elm_lang$core$Native_Utils.update(
			ship,
			{oxygen: oxygen - (dt / 6)}) : _elm_lang$core$Native_Utils.update(
			ship,
			{oxygen: 0});
	});
var _user$project$Consumption$consumption = function (dt) {
	return function (_p2) {
		return A2(
			...
			dt,
			A2(_user$project$Consumption$consumeAir, dt, _p2));
	};
};
...
var _user$project$DrawShip$drawShip = F2(
	function (enoughFuel, t) {
		...
		var shipRendering = enoughFuel ? _elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$GameView$adjustPosition = F3(
	function (_p6, _p5, thing) {
		var _p7 = _p6;
		var _p8 = _p5;
		var _p9 = thing.global;
		var tgx = _p9._0;
		var tgy = _p9._1;
		return {
			ctor: '_Tuple2',
...
var _user$project$GameView$drawAt = function (_p10) {
	var _p11 = _p10;
	var _p13 = _p11._1.sprite;
	var a = _elm_lang$core$Basics$fst(_p11._1.angle);
	var _p12 = _p13.dimensions;
	var w = _p12._0;
	var h = _p12._1;
	return A2(
		...
		A2(
			_evancz$elm_graphics$Collage$move,
			_p11._0,
			A3(_user$project$GameView$image$, w, h, _p13.src)));
};
...
var _user$project$GameView$rotateArea = F2(
	function (_p22, area$) {
		var _p23 = _p22;
		var a = _elm_lang$core$Basics$fst(_p23.angle);
		return _user$project$GameView$layerer(
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
...
var _user$project$GameView$area = _user$project$GameView$layerer(
	_elm_lang$core$Native_List.fromArray(
		[
							...
							A2(
								...
								A2(
									...
									A2(
										...
										ship,
										A2(_user$project$GameView$populateArea, m, _user$project$GameView$area))))),
							_user$project$GameView$sky(ship.global),
							A2(
							_user$project$DrawShip$drawShip,
							_elm_lang$core$Native_Utils.cmp(ship.fuel, 0) > 0,
							ship.thrusters)
						]))
				])));
};
...
var _user$project$Gravity$thingGravity = F2(
	function (dt, thing) {
		var _p4 = thing.velocity;
		var vx = _p4._0;
		var vy = _p4._1;
		var _p5 = A2(_user$project$Gravity$gravity, dt, thing.global);
		var gvx = _p5._0;
		var gvy = _p5._1;
		return _elm_lang$core$Native_Utils.update(
			thing,
...
var _user$project$Gravity$shipGravity = F2(
	function (dt, ship) {
		var _p6 = A2(_user$project$Gravity$gravity, dt, ship.global);
		var gvx = _p6._0;
		var gvy = _p6._1;
		var _p7 = ship.velocity;
		var vx = _p7._0;
		var vy = _p7._1;
		return _elm_lang$core$Native_Utils.update(
			ship,
...
var _user$project$Init$frege = function () {
	...
	return {
		...
		velocity: {ctor: '_Tuple2', _0: 0, _1: -400},
		sector: {
			ctor: '_Tuple2',
			_0: _user$project$Init$setSector(gx),
			_1: _user$project$Init$setSector(gy)
		},
...
var _user$project$Init$o2box = F3(
	function (_p7, _p6, va) {
		var _p8 = _p7;
		var _p11 = _p8._1;
		var _p10 = _p8._0;
...
var _user$project$ThrusterState$set = F2(
	function (m, keys) {
		return A2(_ohanhi$keyboard_extra$Keyboard_Extra$isPressed, keys, m) ? 1 : 0;
	});
...
var _user$project$ReadOut$pad = function (string) {
	pad:
	while (true) {
...
var _user$project$MiniMap$drawThing = function (t) {
	var a = _elm_lang$core$Basics$fst(t.angle);
	var _p0 = t.sprite.dimensions;
	var w = _p0._0;
	var h = _p0._1;
	var _p1 = t.global;
	var x = _p1._0;
	...
	return A2(
		...
		A2(
			_evancz$elm_graphics$Collage$rotate,
			_elm_lang$core$Basics$degrees(a),
			A3(_user$project$MiniMap$image$, (w / 10) | 0, (h / 10) | 0, t.sprite.src)));
};
var _user$project$MiniMap$miniMap = function (m) {
	var _p2 = m.ship.global;
	var x = _p2._0;
	var y = _p2._1;
	return A2(
		_elm_lang$html$Html$div,
...
var _user$project$NavMarkers$navMarkers = function (m) {
	...
	var a = _elm_lang$core$Basics$fst(s.angle);
...
var _user$project$VelocityGauge$velocityGauge = function (_p0) {
	var _p1 = _p0;
	...
	var urgency = (_elm_lang$core$Native_Utils.cmp(15, velocity$) > 0) ? '' : ((_elm_lang$core$Native_Utils.cmp(30, velocity$) > 0) ? 'urgent' : ((_elm_lang$core$Native_Utils.cmp(45, velocity$) > 0) ? 'urgenter' : 'critical'));
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$PauseView$instructions = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_user$project$Components$tinyPoint('\'P\' to pause. Collect resources. Dont run out of air. Dont fly into the planet. Nav markers show nearby resources and point in their relative direction. Gray arrow is north. Blue arrow is your direction.')
		]));
...
var _user$project$View$view = function (model) {
	...
	var ship = _p0.ship;
	var died = _p0.died;
	var deathMsg = _p0.deathMsg;
	var paused = _p0.paused;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$VelocityGauge$velocityGauge(ship),
								_user$project$PauseView$pausedNotice(paused),
								A2(_user$project$DiedView$diedNotice, died, deathMsg)
							])),
...
var _user$project$SetWeight$setWeight = function (ship) {
	var _p0 = ship;
	var fuel = _p0.fuel;
	var oxygen = _p0.oxygen;
	return _elm_lang$core$Native_Utils.update(
		ship,
		{weight: ((fuel / 1.7) + (oxygen * 3)) + 263});
};
...
var _user$project$Thrust$setThrust = function (ship) {
	var weightFactor = ship.weight / 1526;
	var _p2 = ship.velocity;
	var vx = _p2._0;
	var vy = _p2._1;
	var _p3 = ship.angle;
	var a = _p3._0;
	var va = _p3._1;
	var t = ship.thrusters;
	...
	return (_elm_lang$core$Native_Utils.cmp(ship.fuel, 0) > 0) ? _elm_lang$core$Native_Utils.update(
		ship,
		{
...
var _user$project$ShipPosition$axisCrosses = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4._1;
	return (!_elm_lang$core$Native_Utils.eq(
...
var _user$project$ShipPosition$moduloAngle = function (_p6) {
...
var _user$project$ShipPosition$shipPosition = F2(
	function (dt, ship) {
		...
		var a = _p7._0;
		var va = _p7._1;
		var a$ = _user$project$ShipPosition$moduloAngle(a + (dt * va));
		var _p8 = ship.sector;
		var sx = _p8._0;
		var sy = _p8._1;
		...
		return _elm_lang$core$Native_Utils.update(
			ship,
			{
				...
				global: {ctor: '_Tuple2', _0: gx$, _1: gy$},
				angle: {ctor: '_Tuple2', _0: a$, _1: va},
				sector: {ctor: '_Tuple2', _0: sx + dsx, _1: sy + dsy},
				quadrant: _user$project$ShipPosition$setQuadrant(
					{ctor: '_Tuple2', _0: gxm, _1: gym}),
				dir: A2(_elm_lang$core$Basics$atan2, vx, vy)
			});
	});

var _user$project$ThingPosition$getSector = function (f) {
	return _elm_lang$core$Basics$floor(f / 600);
};
...
var _user$project$ThingPosition$thingPosition = F2(
	function (dt, thing) {
		...
		var va = _p1._1;
		var a$ = a + (dt * va);
		var _p2 = thing.velocity;
		var vx = _p2._0;
		var vy = _p2._1;
		var vy$ = dt * vy;
		var vx$ = dt * vx;
		var _p3 = thing.global;
		var x = _p3._0;
		var y = _p3._1;
		var y$ = y + vy$;
		...
		return _elm_lang$core$Native_Utils.update(
			thing,
			{
				local: {ctor: '_Tuple2', _0: xm, _1: ym},
				global: {ctor: '_Tuple2', _0: x + vx$, _1: y + vy$},
				angle: {
					ctor: '_Tuple2',
					_0: _user$project$ThingPosition$moduloAngle(a$),
					_1: va
				},
				sector: {
					ctor: '_Tuple2',
					_0: _user$project$ThingPosition$getSector(x$),
					_1: _user$project$ThingPosition$getSector(y$)
				}
			});
	});
...
var _user$project$Refresh$checkIfDead = function (_p1) {
	var _p2 = _p1;
	var noMoreAir = _elm_lang$core$Native_Utils.cmp(_p2.oxygen, 1) < 0;
	var _p3 = _p2.global;
	var x = _p3._0;
	var y = _p3._1;
	var x$ = x - 60000;
			...
			A2(
				...
				_user$project$Thrust$setThrust(
					_user$project$SetWeight$setWeight(
						A2(_user$project$Consumption$consumption, dt, _p4)))));
	};
};
var _user$project$Refresh$refresh = F2(
	function (dt, m) {
		var _p5 = m;
		var ship = _p5.ship;
		var things = _p5.things;
		var died = _p5.died;
		var _p6 = _user$project$Refresh$checkIfDead(ship);
		var isDead = _p6._0;
		var deathMsg = _p6._1;
		return _elm_lang$core$Native_Utils.update(
			m,
			{
				ship: A2(_user$project$Refresh$refreshShip, dt, ship),
				things: A2(
					_elm_lang$core$List$map,
				...
				if (paused || died) {
					...
					var model$ = function () {
						...
						return A2(
							...
							dt$,
							A2(_user$project$CollisionHandle$collisionsHandle, dt$, model));
					}();
					return {ctor: '_Tuple2', _0: model$, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'HandleKeys':
				var _p2 = A2(_ohanhi$keyboard_extra$Keyboard_Extra$update, _p0._0, model.keys);
				var keys = _p2._0;
				var kCmd = _p2._1;
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$HandleKeys$handleKeys, model, keys),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Types$HandleKeys, kCmd)
				};
			default:
				return _elm_lang$core$Native_Utils.eq(_p0._0, _elm_lang$page_visibility$PageVisibility$Hidden) ? {
					ctor: '_Tuple2',
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$page_visibility$PageVisibility$visibilityChanges(_user$project$Types$Pause)
			]));
};
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Init$initModel, _1: _elm_lang$core$Platform_Cmd$none},
...
Elm['CollisionHandle'] = Elm['CollisionHandle'] || {};
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['SetWeight'], 'SetWeight', typeof _user$project$SetWeight$main === 'undefined' ? null : _user$project$SetWeight$main);
